    ...
    <a-layout-sider width="200" class="sider">
      ...
      >
        ...
        <a-menu-item key="history">
          ...
          <router-link to="/student/history">测评历史</router-link>
        </a-menu-item>
        <a-menu-item key="counselors">
          <template #icon>
            <TeamOutlined />
          </template>
          <router-link to="/student/counselors">咨询师列表</router-link>
        </a-menu-item>
...
// 根据当前路由路径设置选中的菜单项
const selectedKeys = ref<string[]>(['assessments']);
